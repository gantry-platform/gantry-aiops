...
def convert_range_time():
    start_time = '2020-06-15T12:00:08Z'
    #end_time = '2020-06-15T12:51:25Z'
    end_time = '2020-06-16T15:00:00Z' 
    step = '1m'
...
def x_data():
    ...
    for i in range(cnt):
        if cpu_instance[i] == '10.11.0.106:9100':   ## 특정노드 데이터 추출 하드코딩 변경 필요
            ...
            data = str(cpu_value[i]) + "," + str(memory_value[i])  +  "\n"
            # print(data)
            f.write(data) 
