...
pwd
echo "ansible-playbook -i inventory/prod/hosts.yml --become --become-user=root cluster.yml -v"
ansible-playbook -i inventory/prod/hosts.yml --become --become-user=root cluster.yml -v
